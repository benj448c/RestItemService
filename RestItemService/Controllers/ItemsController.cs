...
namespace RestItemService.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        public IEnumerable<Item> GetFromName(string substring)
        {
            return items.FindAll(x => x.Name.Contains(substring));
        }
        ...
        {
            return items.FindAll(x => x.Quality.Contains(substring));
        }
